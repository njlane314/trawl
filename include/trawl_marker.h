...
#define TRAWL_LATENCY_BEGIN(id_)        do { trawl_latency_begin((uint32_t)(id_)); } while (0)
#define TRAWL_LATENCY_END(id_)          do { trawl_latency_end((uint32_t)(id_)); } while (0)
#define TRAWL_LATENCY_BEGIN_ID(id_, t_) do { trawl_latency_begin_id((uint32_t)(id_), (uint64_t)(t_)); } while (0)
#define TRAWL_LATENCY_END_ID(id_, t_)   do { trawl_latency_end_id((uint32_t)(id_), (uint64_t)(t_)); } while (0)
